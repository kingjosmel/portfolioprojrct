  ...
  return (
    <div className="py-32 md:py-48 lg:py-60 relative z-0">
      ...
      <div className="container">
        ...
        <p className="mt-4 text-center text-white/60 md:text-lg">I specialise in transforming designs into functional, high-performing web applications. Lets discuss yout next project.</p>
        </div>
